...
function Hero() {
  return (
    <Section className="pt-32 lg:pt-40 pb-24">
      ...
      <p className="font-['Inter',sans-serif] text-base text-[#6B6B62] leading-relaxed max-w-[600px] mb-8">
  ...
  return (
    <Section alt>
      ...
      <div className="prose-custom space-y-5">
        ...
        <p className="font-['Inter',sans-serif] text-sm text-[#6B6B62] leading-relaxed border-l-2 border-accent pl-4">
      ...
      <div className="mt-10">
        ...
        <div className="bg-[#F5F5F0] border border-border rounded-sm p-8 space-y-4">
          <div>
            <p className="font-['Inter',sans-serif] text-sm font-medium text-foreground mb-1">笔试</p>
            <p className="font-['Inter',sans-serif] text-sm text-[#6B6B62] leading-relaxed">
              100 道选择题，考查理论知识掌握程度。
            </p>
          </div>
          <div className="border-t border-border pt-4">
            <p className="font-['Inter',sans-serif] text-sm font-medium text-foreground mb-1">实践考试</p>
            <p className="font-['Inter',sans-serif] text-sm text-[#6B6B62] leading-relaxed">
