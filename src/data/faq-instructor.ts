...
const instructor: FAQCategory = {
  ...
  items: [
    ...
    {
      id: "daga-vs-icak",
      question: "DAEGAK 和 ICAK 是什么关系？为什么要通过 DAEGAK 学习？",
      answer: "ICAK（国际应用肌动学学院）：1973 年在美国成立，是 PAK 的全球最高学术与认证机构，制定 PAK 的国际培训标准和认证要求，认证全球的 PAK 讲师和课程。\n\nDAEGAK（德国应用肌动学学会）：1996 年由 Hans Garten 博士创立，是 ICAK 在德国的官方合作学会，负责德语区和中文世界的 PAK 培训推广，课程体系与 ICAK 标准完全对接，以德国特有的严谨和标准化著称。\n\n选择健衡学园（DAEGAK 中文课程）而非直接去美国学 ICAK，优势在于：中文授课消除语言障碍；费用和时间成本远低于海外培训；同样的 ICAK 标准、同样的认证价值；更贴近亚洲人群的临床特征和常见病例。",
      keywords: ["DAEGAK", "ICAK关系", "德国学会", "国际学院", "组织架构"],
