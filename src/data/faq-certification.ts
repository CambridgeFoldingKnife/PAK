  ...
  items: [
    {
      ...
      answer: "完整认证路径如下：\n\nDAEGAK 认证（德国应用肌动学学会）\n- 完成 Part I + Part II 面授课程\n- 提交规定数量的临床案例报告\n- 通过书面与实操考核\n- 获得 DAEGAK 颁发的应用肌动学从业者证书\n\nICAK 国际认证（国际应用肌动学学院）\n- ICAK 是全球最高级别的应用肌动学认证机构，总部位于美国\n- DAEGAK 是 ICAK 在德国的官方合作学会，课程体系与 ICAK 标准完全对接\n- 获得 DAEGAK 认证后，满足 ICAK 规定的额外学时和考核要求，即可申请 ICAK 国际认证\n- ICAK 认证在全球应用肌动学领域具有最高权威性\n\n简单理解：DAEGAK 是入行证，ICAK 是专家证。大部分学员先获得 DAEGAK 认证，在临床积累一定经验后再申请 ICAK 认证。",
    ...
    },
    {
      ...
      answer: "ICAK 认证的正式要求：\n\n- 100 小时经 ICAK 认证讲师授课的培训学时（Part I + Part II 面授满足此要求）\n- 笔试：覆盖解剖、生理、PAK 理论与诊断模型\n- 实操考核：在规定时间内完成特定肌肉的标准测试流程，并准确解读结果\n- 案例报告：提交若干份完整的 PAK 评估与治疗案例文档\n\n关于难度：根据往期学员反馈，只要认真完成课程中的实操练习和课后临床实践，考核的通过率在 90% 以上。最大的挑战不在考试本身，而在于将 PAK 思维真正融入日常临床工作。建议在 Part II 结束后至少积累 3-6 个月的临床实践再参加 ICAK 认证考试。",
